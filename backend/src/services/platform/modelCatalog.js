...
export const MODEL_GROUPS = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'llm:openrouter:gemma-3-12b-free', value: 'google/gemma-3-12b-it:free', label: 'Gemma 3 12B (Free / OpenRouter)', provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
      { id: 'llm:openrouter:gemma-3-4b-free',  value: 'google/gemma-3-4b-it:free',  label: 'Gemma 3 4B (Free / OpenRouter)',  provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
