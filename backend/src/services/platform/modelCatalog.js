...
export const MODEL_GROUPS = [
  ...
  },
  {
    ...
    models: [
      ...
      { id: 'llm:openrouter:dots-3-free',         value: 'dots-studio/dots-3-note-preview:free', label: 'Dots 3 Preview (Free / OpenRouter)',    provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
      { id: 'llm:openrouter:minimax-m27-free',    value: 'minimax/minimax-m2.7:free',            label: 'MiniMax M2.7 (Free / OpenRouter)',      provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
      { id: 'llm:openrouter:llama-3.3-70b-free', value: 'meta-llama/llama-3.3-70b-instruct:free', label: 'Llama 3.3 70B (Free / OpenRouter)', provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
      { id: 'llm:openrouter:llama-3.1-8b-free',  value: 'meta-llama/llama-3.1-8b-instruct:free',  label: 'Llama 3.1 8B (Free / OpenRouter)',  provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
      { id: 'llm:openrouter:qwen-2.5-72b-free',  value: 'qwen/qwen-2.5-72b-instruct:free',  label: 'Qwen 2.5 72B (Free / OpenRouter)',  provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
      { id: 'llm:openrouter:gemini-2.0-flash-free', value: 'google/gemini-2.0-flash-exp:free', label: 'Gemini 2.0 Flash (Free / OpenRouter)', provider: 'OpenRouter', envKey: 'OPENROUTER_API_KEY' },
