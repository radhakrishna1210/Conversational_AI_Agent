    ...
    res.json({
      ...
      ambience: {
        ...
        nativeReason: capabilities.providerName === 'FishAudio'
          ? (/^s2/.test(process.env.FISH_TTS_MODEL || 's2.1-pro') ? null : `Fish model ${process.env.FISH_TTS_MODEL} does not take inline tags.`)
          : `Native ambience is generated by Fish Audio with the speech; this agent's voice is ${capabilities.providerName || 'not set'}.`,
