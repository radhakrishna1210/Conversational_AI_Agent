...
export const env = {
  ...
  PIPEDRIVE_CLIENT_ID: optional('PIPEDRIVE_CLIENT_ID'),
  PIPEDRIVE_CLIENT_SECRET: optional('PIPEDRIVE_CLIENT_SECRET'),
  PIPEDRIVE_REDIRECT_URI: optional('PIPEDRIVE_REDIRECT_URI'),
  ...
  // https://chatflow.mannmate.com hostname: that would hairpin every internal call
