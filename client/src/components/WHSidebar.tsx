...
const navItems: NavGroup[] = [
  ...
  },
  {
    group: 'CORE MODULES',
    items: [
      { label: 'Number Setup', path: '/wh/number-setup', icon: (
      ...
      { label: 'API Management', path: '/wh/api', icon: (
      ...
      { label: 'Templates', path: '/wh/templates', icon: (
      ...
      { label: 'Campaigns', path: '/wh/campaigns', icon: (
  ...
  },
  {
    group: 'ENGAGEMENT',
    items: [
      { label: 'Live Inbox', path: '/wh/inbox', icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"/></svg>
      )},
      { label: 'Automation', path: '/wh/automation', icon: (
  ...
  },
  {
    group: 'INSIGHTS',
    items: [
      { label: 'Analytics', path: '/wh/analytics', icon: (
        <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="18" y1="20" x2="18" y2="10"/><line x1="12" y1="20" x2="12" y2="4"/><line x1="6" y1="20" x2="6" y2="14"/></svg>
      )},
      { label: 'Settings', path: '/wh/settings', icon: (
