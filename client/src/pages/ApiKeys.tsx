    ...
    <>
      ...
      <div style={{
        ...
        {loading ? (
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'minmax(220px, 1fr) minmax(320px, 1.4fr) minmax(140px, 1fr) 100px minmax(180px, 1.2fr)', gap: '16px', alignItems: 'center' }}>
            ...
            {apiKeys.map((key) => (
              <Fragment key={key.id}>
                ...
                <div style={{ color: 'var(--text-secondary)', fontSize: '13px', textAlign: 'center' }}>{key.environment ?? 'live'}</div>
