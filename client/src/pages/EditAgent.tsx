...
interface PostCallConfig {
  ...
  /** extracted-variable key holding the contact's first name — optional; see emailVariable */
  firstNameVariable?: string;
  /** extracted-variable key holding the contact's last name — optional; see emailVariable */
              ...
              >
                <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'flex-start', gap: '20px', marginBottom: '24px' }}>
                  <div style={{ flex: 1 }}>
                    ...
                    {config.deliveryMethod === 'Salesforce' && (
                      <div style={{ marginTop: '14px' }}>
