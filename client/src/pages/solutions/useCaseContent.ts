  ...
  export const solutionUseCases = {
    collections: {
      ...
      faqs: [
        {
          question: 'How can Spandan help with payment reminders?',
          answer:
        ...
        },
        {
          ...
          answer:
            'Yes. You can monitor calls, outcomes, customer interactions, and collection performance from your Spandan dashboard.',
        },
      ],
      cta: {
    ...
    negotiation: {
      ...
      faqs: [
        {
          question: 'How can Spandan help with customer negotiations?',
          answer:
    ...
    customerSupport: {
      ...
      faqs: [
        {
          question: 'How can Spandan help with customer support?',
          answer:
    ...
    appointments: {
      ...
      faqs: [
        {
          question: 'How can Spandan help with appointment scheduling?',
          answer:
...
export const verticalUseCases = {
  realEstate: {
    ...
    faqs: [
      {
        question: 'How can Spandan help with property inquiries?',
        answer:
      ...
      },
      {
        ...
        answer:
          'Yes. Spandan connects with Salesforce, HubSpot, Zoho CRM, and many other platforms.',
      },
      {
  ...
  healthcare: {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          'Yes. Spandan connects with tools like Google Calendar, Outlook, and popular EMR systems.',
      },
    ],
    cta: {
