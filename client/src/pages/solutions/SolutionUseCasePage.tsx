...
function SolutionHero({ content }: { content: SolutionUseCaseContent }) {
  ...
  return (
    <section className="solution-hero" aria-labelledby={headingId}>
...
function QuickStartTemplates({ content }: { content: SolutionUseCaseContent }) {
  ...
  return (
    <section className="solution-section" aria-labelledby={headingId}>
      <div className="container">
        <div className="solution-template-panel">
          <div>
            <div className="solution-eyebrow">Quick Start Templates</div>
            <h2 id={headingId}>Create your Free Voice AI Assistant</h2>
            <p>Start from a focused workflow, then tailor the assistant to your team, tone, and customer journey.</p>
          </div>
    ...
    <section className="solution-section" aria-labelledby={headingId}>
      <div className="container">
        <div className="solution-section-header">
          <div className="solution-eyebrow">{content.eyebrow}</div>
          <h2 id={headingId}>Built for the way your team works</h2>
          <p>Reusable voice workflows for real customer conversations, follow-ups, and operational handoffs.</p>
        </div>
    ...
    <section className="solution-section solution-faq-section" aria-labelledby={headingId}>
      <div className="container">
        <div className="solution-section-header">
          ...
          <h2 id={headingId}>Common questions about {content.slug.replace('-', ' ')}</h2>
          <p>Clear answers for teams evaluating this voice AI workflow.</p>
        </div>
...
export default function SolutionUseCasePage({ content }: { content: SolutionUseCaseContent }) {
  return (
    <main className="solution-page">
      ...
      <QuickStartTemplates content={content} />
