...
const faqs = [
  {
    question: 'How does Spandan help with lead generation?',
    answer:
  ...
  {
    question: 'Can Spandan make outbound calls to prospects?',
    answer:
  ...
  {
    question: 'How does Spandan qualify leads automatically?',
    answer:
  ...
  {
    question: 'Can I integrate Spandan with my CRM or lead management tools?',
    answer:
  ...
  {
    question: 'What kind of industries can use Spandan for lead generation?',
    answer:
  ...
  {
    question: 'Can Spandan send leads to my sales team after qualification?',
    answer:
  ...
  {
    question: 'Can Spandan run campaigns in multiple languages?',
    answer:
      'Yes. You can create multilingual campaigns so prospects can speak in the language they prefer.',
  },
  {
    question: 'How does Spandan price lead generation campaigns?',
    answer:
          ...
          <div className="grid gap-10 lg:grid-cols-[1.04fr_0.96fr] lg:gap-12">
            ...
            >
              ...
              <h1 className="max-w-[720px] text-[46px] font-extrabold leading-[1.06] tracking-[-0.05em] text-black dark:text-white lg:text-[58px]">
                Generate Leads <span className="text-[var(--cyan)] dark:text-[var(--cyan-fg)]">On Autopilot</span>
              </h1>
        ...
        <section className="relative mx-auto max-w-[1480px] px-6 pb-24 lg:px-10 lg:pb-28">
          <div className="text-center">
            <h2 className="text-[54px] font-extrabold tracking-[-0.05em] text-black dark:text-white lg:text-[60px]">
              Lead Generation Voice AI <span className="text-[var(--cyan)] dark:text-[var(--cyan-fg)]">Solutions</span>
            </h2>
